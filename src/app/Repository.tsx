...
export default async function Repository() {
	const res: { data: { data: GithubRepository } } = await instance.get(
		`/github/repository/${process.env.NEXT_PUBLIC_GITHUB_USERNAME}/frontend-portfolio`,
	);

	return (
		<div className="widget col-span-full flex items-center xl:col-span-1 2xl:col-span-2">
			<CardContainer>
				<CardBody className="group/card relative h-full rounded-xl bg-gray-50 p-6 dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1]">
					...
					<CardItem translateZ="100" className="mt-4 w-full">
						<ScrollArea className="h-[400px] rounded-xl">
							<Image
								priority
								src={"/repositories/frontend-portfolio.screenshot.png"}
								width={0}
								height={0}
								sizes="100vw"
